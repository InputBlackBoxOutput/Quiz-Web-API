...
#### STEP 1: Add the following to your HTML file and make changes to 'QuestionBank' object
<code>
	<!-- Add the following link tag in the head tag -->
...
#### STEP 2: Add quiz.js to the directory containing the HTML file
